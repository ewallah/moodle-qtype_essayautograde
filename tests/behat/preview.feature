...
Feature: Preview Essay autograde questions
  ...
  Scenario: Preview an Essay autograde question and submit a partially correct response.
    When I choose "Preview" action for "essayautograde-001" in the question bank
  ...
  @javascript @_switch_window
  Scenario: Preview an Essay autograde question and submit a partially correct response.
    When I choose "Preview" action for "essayautograde-002" in the question bank
    And I switch to "questionpreview" window
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Start again with these options"
    And I should see "Please write a story about a frog."
  ...
  @javascript @_switch_window
  Scenario: Preview an Essay autograde question and submit a partially correct response.
    When I choose "Preview" action for "essayautograde-003" in the question bank
    And I switch to "questionpreview" window
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Start again with these options"
    And I should see "Please write a story about a frog."
